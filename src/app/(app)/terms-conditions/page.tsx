...
const TermsConditionsPage = () => {
  return (
    <div className="py-24 prose w-full  min-w-[50%] p-2 text-textColor
    prose-a:text-accent prose-code:text-textColor prose-code:font-mono
    prose-headings:text-textColor prose-headings:font-bold mx-auto">
      <div className="container">
        <h1>TERMS OF SERVICE</h1>
        <small>Last updated October 03, 2021</small>
        <h3 className="mt-5">AGREEMENT TO TERMS</h3>
        <article>
          <p>
            {" "}
            These Terms of Use constitute a legally binding agreement made
            between you, whether personally or on behalf of an entity (“you”)
            and physicsDojo.ai ("Company," “we," “us," or “our”), concerning your access
            to and use of the https://www.physicsDojo.ai website as well as any other
        ...
        <h3 className="mt-5">USER REPRESENTATIONS</h3>
        <div className="mt-5">
          <p>
            {" "}
        ...
        <h3 className="mt-5">USER REGISTRATION</h3>
        <div className="mt-5">
          {" "}
        ...
        <h3 className="mt-5">PROHIBITED ACTIVITIES</h3>
        <div className="mt-5">
          <p>
            {" "}
        ...
        <h3 className="mt-5">USER GENERATED CONTRIBUTIONS </h3>
        <div className="mt-5">
          <p>
            {" "}
        ...
        <h3 className="mt-5">CONTRIBUTION LICENSE</h3>
        <div className="mt-5">
          <p>
            {" "}
        ...
        <h3 className="mt-5">GUIDELINES FOR REVIEWS</h3>
        <div className="mt-5">
          <p>
            {" "}
        ...
        <h3 className="mt-5">SUBMISSIONS</h3>
        <div className="mt-5">
          <p>
            {" "}
        ...
        <h3 className="mt-5">THIRD-PARTY WEBSITE AND CONTENT</h3>
        <div className="mt-5">
          <p>
            {" "}
        ...
        <h3 className="mt-5">SITE MANAGEMENT</h3>
        <div className="mt-5">
          <p>
            {" "}
        ...
        <h3 className="mt-5">TERM AND TERMINATION</h3>
        <div className="mt-5">
          <p>
            {" "}
        ...
        <h3 className="mt-5">MODIFICATIONS AND INTERRUPTIONS</h3>
        <div className="mt-5">
          <p>
        ...
        <div className="mt-5">
          <p>
            ...
            physicsDojo.ai and yourself both agree to submit to the non-exclusive
            jurisdiction of the courts of __________, which means that you may
            make a claim to defend your consumer protection rights in regards to
            these Conditions of Use in the United Kingdom, or in the EU country
            in which you reside.{" "}
          </p>
        </div>
        <h3 className="mt-5">DISPUTE RESOLUTION</h3>
        <h6 className="mt-5">Informal Negotiations</h6>
        <div className="mt-5">
          <p>
            {" "}
        ...
        <h6 className="mt-5">Binding Arbitration</h6>
        <div className="mt-5">
          <p>
            {" "}
        ...
        <div className="mt-5">
          <p>
            ...
            arbitrated on a className-action basis or to utilize className action
        ...
        <h3 className="mt-10">CORRECTIONS</h3>
        <div>
          <p>
        ...
        <h3 className="mt-5">LIMITATIONS OF LIABILITY</h3>
        <div className="mt-5">
          {" "}
        ...
        <h3 className="mt-5">CALIFORNIA USERS AND RESIDENTS</h3>
        <div className="mt-5">
          <p>
        ...
        <h3 className="mt-10">CONTACT US </h3>
        <p className="mt-5">
          In order to resolve a complaint regarding the Site or to receive
          further information regarding use of the Site, please contact us at:{" "}
        </p>
        <div className="font-weight-bold">
          <div>physicsDojo.ai </div>
          <div>Gilesgate</div>
          <div>Durham, Durham DH11JA</div>
          <div>England</div>
          <div>Phone: +447596371436</div>
          <div>adam@eigensolvers.org</div>
        </div>
        <div className="mt-10">
